...
description: Avrupa Birliği Dijital Hizmetler Kanunu (DSA), çevrimiçi platformlar
  için kapsamlı bir düzenleme çerçevesi sunmaktadır. DSA, pazar yerleri, sosyal medya
  ağları, uygulama mağazaları ve çevrimiçi seyaha...
...
Avrupa Birliği Dijital Hizmetler Kanunu (DSA), çevrimiçi platformlar için kapsamlı bir düzenleme çerçevesi sunmaktadır. DSA, pazar yerleri, sosyal medya ağları, uygulama mağazaları ve çevrimiçi seyahat platformları gibi hizmetler için kurallar getirmektedir. Kanunun temel amacı, vatandaşların ve tüketicilerin temel haklarına saygılı bir dijital alan oluşturmaktır. DSA, özellikle reşit olmayanların korunması, yasadışı içerikle mücadele ve platform şeffaflığı konularında özel hükümler içermektedir. DSA, Dijital Piyasalar Kanunu (DMA) ile tamamlanmaktadır.

## Key Points

- AB Dijital Hizmetler Kanunu (DSA) kapsamlı çerçeve
- Platform şeffaflığı ve hesap verebilirlik
- Reşit olmayanların korunması hükümleri
- Türkiye'nin DSA uyum süreci
