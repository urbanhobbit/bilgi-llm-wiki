---
type: raw_article
title: Erişilemedi (http_404 - Not found)
description: This UK Information Commissioner's Office (ICO) guidance page was intended
  to provide organizations with practical advice on protecting children's data under
  UK data protection law, particularly the U...
...
# Erişilemedi (http_404 - Not found)
...
This UK Information Commissioner's Office (ICO) guidance page was intended to provide organizations with practical advice on protecting children's data under UK data protection law, particularly the UK General Data Protection Regulation (UK GDPR) and the Data Protection Act 2018. The ICO is the UK's independent regulator for data protection and information rights. This specific guidance page would have addressed the enhanced protections afforded to children's personal data under UK data protection law, including the requirement for age-appropriate design, the Age Appropriate Design Code (also known as the Children's Code) which came into effect in 2021 and sets standards for online services likely to be accessed by children, and the principle of best interests of the child as a primary consideration. The guidance would have covered key obligations such as data minimization principles requiring that only the minimum necessary data be collected from children, default privacy settings that are automatically set to the highest level, transparent information about data processing in child-friendly language, and restrictions on nudge techniques that encourage children to weaken their privacy protections. The ICO's guidance is influential globally as a model for child data protection regulation and has informed similar approaches in other jurisdictions including the EU, Australia, and parts of the United States. The 404 status indicates the page has been moved, restructured, or removed from the ICO website.

## Key Points

- UK ICO guidance on protecting children's data under UK GDPR and Age Appropriate Design Code
- HTTP 404 - page not found or restructured
- Children's Code sets standards for age-appropriate design and data minimization
