---
type: raw_article
title: BİLGİ TTO (Technology Transfer Office) - LinkedIn
description: İstanbul Bilgi Üniversitesi Teknoloji Transfer Ofisi'nin (TTO) LinkedIn
  sayfası, üniversitenin AR-GE, inovasyon, teknoloji transferi, proje yönetimi ve
  proje yazımı alanlarındaki faaliyetlerini tanıtm...
...
# BİLGİ TTO (Technology Transfer Office) - LinkedIn
...
İstanbul Bilgi Üniversitesi Teknoloji Transfer Ofisi'nin (TTO) LinkedIn sayfası, üniversitenin AR-GE, inovasyon, teknoloji transferi, proje yönetimi ve proje yazımı alanlarındaki faaliyetlerini tanıtmaktadır. Sayfada 2.211 takipçi bulunan ofis, Eyüp, İstanbul merkezlidir. 2-10 çalışanı bulunan ofis, TÜBİTAK 1711 Yapay Zekâ Ekosistem Çağrısı gibi güncel projeler hakkında paylaşımlar yapmaktadır.

## Key Points

- İstanbul Bilgi Üniversitesi TTO'su 2.211 takipçili LinkedIn sayfası
- TÜBİTAK 1711 Yapay Zekâ Ekosistem Çağrısı kapsamında 5 alan
- Üniversite-sanayi işbirliği modeli
- Türkiye'de TTO sayısı artıyor, değerlendirme mekanizması eksik
- KVKK uyumu teknoloji transfer süreçlerinde kritik
